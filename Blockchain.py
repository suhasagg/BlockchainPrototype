...
class Blockchain():
    ...
    def executeTransaction(self, transaction):
        ...
        #Staking type of transaction
        #Stake Amount is added to users balance
        #POS map corresponding to public key staking amount gets binded
        #User Blockhain Account - Amount is debited
            if sender == receiver:
